...
// Type: Utf8Json.Formatters.NonGenericListFormatter`1
...
{
  public sealed class NonGenericListFormatter<T> : IJsonFormatter<T>, IJsonFormatter
    where T : class, IList, new()
  {
    ...
    public T Deserialize(ref JsonReader reader, IJsonFormatterResolver formatterResolver)
    {
      ...
      while (!reader.ReadIsEndArrayWithSkipValueSeparator(ref count))
        obj.Add(formatterWithVerify.Deserialize(ref reader, formatterResolver));
      return obj;
    }
  }
}

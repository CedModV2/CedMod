...
namespace UnityEngine.PostProcessing
{
  ...
  public class PostProcessingBehaviour : MonoBehaviour
  {
    ...
    private void Start()
    {
      ...
      if ((UnityEngine.Object) networkIdentity == (UnityEngine.Object) null)
        networkIdentity = this.GetComponentInChildren<NetworkIdentity>();
      if (!((UnityEngine.Object) networkIdentity != (UnityEngine.Object) null) || networkIdentity.isLocalPlayer)
        return;

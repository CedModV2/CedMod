...
namespace CedMod.GameMode.Survival
{
	public class Methods
	{
		...
		public Methods(Player plugin) => this.plugin = plugin;
		...
		public IEnumerator<float> SpawnDbois(List<ReferenceHub> hubs)
		{
			foreach (ReferenceHub hub in hubs)
			{
				...
				hub.Broadcast(30, "<color=orange>You are a Dboi, you need to find a hiding place and pray you are the last person alive, the nuts wil be release at their chamber in 2 minutes.</color>",false);
		...
		public IEnumerator<float> SpawnNuts(List<ReferenceHub> hubs)
		{
			foreach (ReferenceHub hub in hubs)
			{
				...
				hub.Broadcast(120, "<color=red>You are a Nut, once this notice disapears (2 minutes), you will be set loose to kill the Dbois!</color>", false);
            ...
            yield return Timing.WaitForSeconds(UnityEngine.Random.Range(180f, 360f));
            ...
            yield return Timing.WaitForSeconds(1f);
            Map.Broadcast("<color=red>9</color>", 1,false);
            yield return Timing.WaitForSeconds(1f);
            Map.Broadcast("<color=red>8</color>", 1,false);
            yield return Timing.WaitForSeconds(1f);
            Map.Broadcast("<color=red>7</color>", 1,false);
            yield return Timing.WaitForSeconds(1f);
            Map.Broadcast("<color=red>6</color>", 1,false);
            yield return Timing.WaitForSeconds(1f);
            Map.Broadcast("<color=red>5</color>", 1,false);
            yield return Timing.WaitForSeconds(1f);
            Map.Broadcast("<color=red>4</color>", 1,false);
            yield return Timing.WaitForSeconds(1f);
            Map.Broadcast("<color=red>3</color>", 1,false);
            yield return Timing.WaitForSeconds(1f);
            Map.Broadcast("<color=red>2</color>", 1,false);
            yield return Timing.WaitForSeconds(1f);
            Map.Broadcast("<color=red>1</color>", 1,false);
            Map.DetonateNuke();
		}

  ...
  private IEnumerator<float> UseMedicalItem(int mid)
  {
    if (!NetworkServer.active)
    {
      ...
      return (IEnumerator<float>) null;
        ...
        return (IEnumerator<float>)new UseMedicalItem(d__24(0));
      {
            ConsumableAndWearableItems consumableAndWearableItems = this; consumableAndWearableItems = consumableAndWearableItems;
      mid = mid;
    };
  }

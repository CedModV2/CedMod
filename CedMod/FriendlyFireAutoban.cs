    ...
    public static class FriendlyFireAutoban
    {
        ...
        public static bool IsTeamKill(DyingEventArgs ev)
        {
            ...
            switch (ev.Killer.Team)
            {
                ...
                case Team.MTF when ev.Target.Team == Team.CDP && ev.Target.Inventory.IsDisarmed() && CedModMain.Singleton.Config.CedMod.AutobanDisarmedClassDTk:
                case Team.CHI when ev.Target.Team == Team.RSC && ev.Target.Inventory.IsDisarmed() && CedModMain.Singleton.Config.CedMod.AutobanDisarmedScientistDTk:
                case Team.CDP when ev.Target.Team == Team.CDP && CedModMain.Singleton.Config.CedMod.AutobanClassDvsClassD:
                    result = true;
                    break;
                case Team.CDP when ev.Target.Team == Team.CDP && !CedModMain.Singleton.Config.CedMod.AutobanClassDvsClassD:
                default:

    ...
    public static class FpcServerPositionDistributorPatch
    {
        ...
        public static bool Prefix(ReferenceHub receiver, NetworkWriter writer)
        {
            ...
            foreach (ReferenceHub hub in ReferenceHub.AllHubs)
            {
                ...
                PlayerValidatedVisibilityEventArgs ev = new PlayerValidatedVisibilityEventArgs(receiver, hub, receiver.GetTeam() == Team.SCPs || !doChecking ? !invisible : !losCheckInvisible);

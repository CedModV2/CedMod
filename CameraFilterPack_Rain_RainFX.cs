  ...
  private void OnRenderImage(RenderTexture sourceTexture, RenderTexture destTexture)
  {
    if ((Object) this.SCShader != (Object) null)
    {
      ...
      for (int index = 0; index < 4; ++index)
      {
        ...
        this.material.SetVector("Coord" + (object) (index + 1), new Vector4(this.Coord[index].x, this.Coord[index].y, (float) (int) animationCurve2.Evaluate(this.Coord[index].z), this.Coord[index].w));
      }
